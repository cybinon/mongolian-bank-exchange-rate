...
## Гүйцэтгэлийг сайжруулах (Parallel crawling)

Энэ төсөл HTTP хүсэлтүүдийг I/O-д хүлээлгэдэг тул crawler-уудыг thread-ээр зэрэг ажиллуулах нь нийт хугацааг мэдэгдэхүйц бууруулдаг.

- ENABLE_PARALLEL=true болгосноор бүх банкны crawler зэрэг гүйцэтгэгдэнэ.
- MAX_WORKERS-оор зэрэг ажиллах crawler-ийн дээд тоог тохируулна.
...
- Өгөгдлийн сан руу хадгалалтыг гол урсгалд дараалан хийдэг тул session-ийн аюулгүй байдал хангагдсан.
- Зарим банк удаан хариулах үед нийт хугацаа хамгийн удаан банкнаас бага зэрэг хамаарна.
